...
<!-- Font Awesome -->
<link rel="stylesheet" href="{{ url('adminlte/css/font-awesome-4.7.0/css/font-awesome.min.css') }}">
<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css"> -->
<!-- Ionicons -->
<link rel="stylesheet" href="{{ url('adminlte/css/ionicons-2.0.1/ionicons.min.css') }}">
...
<link rel="stylesheet" href="{{ url('adminlte/css/jquery-ui-timepicker-addon.min.css') }}">
...
<link rel="stylesheet" href="{{ url('adminlte/css/bootstrap-datepicker.standalone.min.css') }}">
